          ...
          child: ListView(
            children: <Widget>[
              ...
              FlatButton(
                child: Text("Copy"),
                onPressed: ((){
                  Clipboard.setData(ClipboardData(text: "${json.encode(_grandfather)}"));
                }),),
              Padding(
              ...
              FlatButton(
                child: Text("Copy"),
                onPressed: ((){
                  Clipboard.setData(ClipboardData(text: "${json.encode(_adultFather)}"));
                }),),
              Padding(
                child: Text("Adult Father:\n${_adultNoChildren}"),
                padding: EdgeInsets.only(top: 30.0),
              ...
              FlatButton(
                child: Text("Copy"),
                onPressed: ((){
                  Clipboard.setData(ClipboardData(text: "${json.encode(_adultNoChildren)}"));
                }),),
              Padding(
                child: Text("Adult Father:\n${_grandchild}"),
                padding: EdgeInsets.only(top: 30.0),
              ...
              FlatButton(
                child: Text("Copy"),
                onPressed: ((){
                  Clipboard.setData(ClipboardData(text: "${json.encode(_grandchild)}"));
                }),),
            ],
          ),
