...
class MyHomePage extends StatelessWidget {
  ...
  final List<Customer> _customerList = [
    ...
    Customer("Trust Corp" , "Atlanta", [
      Order(DateTime(2018,1,3),"Shredder parts", 197.02),
    ...
    Customer("Jilly Boutique" , "Birmingham", [
      ...
      Order(DateTime(2018,3,13),"Desk unit", 12.25),
      Order(DateTime(2018,5,2),"Clothes rack", 97.15),
    ]),
  ];
...
ListTile createHomePageListItem(
    ...
    return new ListTile(
      ...
      onTap: () => _pageController.animateToPage(
          index + 1, duration: _duration, curve: _curve),);
}
...
ListTile createOrderListWidget(
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text("PageView Navigation"), actions: <Widget>[
        IconButton(
          icon: Icon(Icons.home),
          onPressed: () => _pageController.animateToPage(
              0, duration: _duration, curve: _curve),)
      ],),
      body: new Center(
