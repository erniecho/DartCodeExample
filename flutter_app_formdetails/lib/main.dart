...
class PersonInfo {
  ...
  @override
  String toString() {
    return 'PersonInfo{_fname: $_fname, _lname: $_lname, _sex: $_sex, '
        '_addr1: $_addr1, _addr2: $_addr2, _city: $_city, _state: $_state, '
        '_zip: $_zip, _fiveYears: $_fiveYears, _dob: $_dob}';
  }
}
...
class _AddressWidgetState extends State<AddressWidget> {
  static const STATE_DROPDOWN_MENU_ITEMS = [
    ...
    DropdownMenuItem(value: "VA", child: const Text("Virgina"),),
    DropdownMenuItem(value: "WA", child: const Text("Washington"),),
    DropdownMenuItem(value: "WV", child: const Text("West Virgina"),),
  ...
  TextEditingController _add2TextController;
  ...
  _AddressWidgetState(final PersonInfo address) {
    ...
    _sex = address.sex;
    _add1TextController = TextEditingController(text: address.addr1);
    _add2TextController = TextEditingController(text: address.addr2);
  ...
  @override
  Widget build(BuildContext context) {
    List<Widget> fromWidgetList = new List();
    fromWidgetList.add(createFNameWidget());
    fromWidgetList.add(createLNameWidget());
    fromWidgetList.add(createSexWidget());
    fromWidgetList.add(createAdd1Widget());
    fromWidgetList.add(createAdd2Widget());
    fromWidgetList.add(createCityWidget());
    fromWidgetList.add(createStateWidget());
    fromWidgetList.add(createZipWidget());
    fromWidgetList.add(createFiveYearsWidget());
    fromWidgetList.add(createDobWidget());
    fromWidgetList.add(RaisedButton(
      onPressed: (){
    ...
    return Form(key: _formKey, child: Column(children: fromWidgetList),);
  }
  ...
  TextFormField createAdd1Widget()  {
    return new TextFormField(
        // ignore: missing_return
        validator: (value) {
          if (value.isEmpty) {
            // ignore: missing_return
            return 'Enter the first line of address.';
          }
        },
        decoration: InputDecoration(
  ...
  TextFormField createAdd2Widget()  {
    return new TextFormField(
        // ignore: missing_return
        validator: (value) {
          if (value.isEmpty) {
            // ignore: missing_return
            return 'Enter the second line of address.';
          }
        },
        decoration: InputDecoration(
            icon: const Icon(Icons.location_city),
        ...
        onSaved: (String value) {},
        controller: _add2TextController);
  }
