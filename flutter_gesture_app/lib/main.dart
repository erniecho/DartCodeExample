        ...
        child: new Column(
          ...
          children: <Widget>[
            GestureDetector(
              ...
              onVerticalDragDown: (details) => _logGesture(
                  'onVerticalDragDown: ${details}'),
              onVerticalDragStart: (details) => _logGesture(
                  'onVerticalDragStart: ${details}') ,
              onVerticalDragUpdate: (details) => _logGesture(
                  'onVerticalDragUpdate: ${details}') ,
              onVerticalDragEnd: (details) => _logGesture(
                  'onVerticalDragEnd: ${details}') ,
              onVerticalDragCancel: () => _logGesture(
